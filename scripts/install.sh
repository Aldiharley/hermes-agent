...
# Configuration
REPO_URL_SSH="git@github.com:Aldiharley/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/Aldiharley/hermes-agent.git"
...
print_success() {
    ...
    echo -e "   ${GREEN}hermes model${NC}        Choose your LLM provider and model"
    ...
    echo -e "${CYAN}─────────────────────────────────────────────────────────${NC}"
    echo ""
    echo -e "${CYAN}${BOLD}🦙 Local Ollama:${NC}"
    echo ""
    echo -e "   Already have ${GREEN}ollama serve${NC} running on localhost:11434? Hermes"
    echo -e "   auto-detects it — no API key, no config. Run ${GREEN}hermes model${NC} and"
    echo -e "   pick \"Local Ollama\" to use whatever models you've pulled."
    echo ""
